...
public class MovieDAO {
	...
	private final String truncate = "truncate cgv_movie"; // cgv_movie 테이블 비우기
	private final String selectOne = "select mvr]Rank,mvTitle,mvScore,mvDirectorName,mvActors,mvinfo,mvReleaseDate,mvGenre,mvPos from cgv_movie where mvRank=?";
