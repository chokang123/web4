...
<body>
 ...
 <header class="heaader-container">
        ...
        <div class="heaader-item"><a href="mypage.jsp"><img src="image/loginMember.png" width="36" height="36" >MY CGV</a></div>
         <div class="heaader-item"><a href="service.jsp"><img src="image/loginCustomer.png" width="36" height="36" >고객센터</a></div>
        </c:when>
        <c:otherwise>
    ...
    <form action="ticket.jsp" method="post" id="form-mslc">
		<input type="text" class="mslc" name="mslc" hidden="hidden">
         ...
         <article class="container article-container">
			       <div class="article-title">
            EVENT
             <button class="article-btn"> <a href="eventfullview.jsp">전체보기</a></button>
        </div>
        <div class="article-card">
   ...
   <div id="specialHall">
      ...
      <div class="specialHall_content">
         ...
         <ul class="specialHall_content_right_list">
            <li class="theater1">
               <a href="specialTheater_SUITE_CINEMA.jsp">
            ...
            <li class="theater2">
               <a href="specialTheater_CINE_LIVINGROOM.jsp">
            ...
            <li class="theater4">
               <a href="specialTheater_CINEdeCHE.jsp">
...
<script>
 ...
 <script>
        ...
        function pageLoad(){
            ...
            if(notShowPop!="true"){
	           	 window.open("popup.html","himedia","width=240, height=280, menubar=no, toolbar=no, location=no, resizable=no, status=no");
