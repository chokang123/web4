...
import action.BoardSubSandAction;
...
public class FrontController extends HttpServlet {
	...
	private void actionDo(HttpServletRequest request, HttpServletResponse response)
		...
		}else if(command.equals("/boardSub.do")) {
			System.out.println("로그:FrontController: 게시판의 댓글 작성 요청");
			try {
				forward = new BoardSubSandAction().execute(request, response);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
